...
# === Managing the files ===
pdb_id = '1C2X'
pdb_url  = './../Graph/C1-f1850-s3104/heavy_C1-f1850-s3104.pdb'
json_url = '../Graph/C1-f1850-s3104/heavy_C1-f1850-s3104.json'   # json file from DSSR analysis "x3dna-dssr --input={pdb_path} --output={json_path} --json --prefix={prefix_path}

RMSF_URL     = '../1C2X_ttclust/clusters_xtc/rmsf_cluster_1.xvg'
Data_1M7_URL = '../Graph/exp_data/PDB_1M7_noSAM_noMg_T30C_all_RNAPDB022.shape'
Data_DMS_URL = '../Graph/exp_data/PDB_DMS_noSAM_noMg_T30C_all_RNAPDB022.shape'
