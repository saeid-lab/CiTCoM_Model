...
filein=md_eq6_rep.mdp
filegro=md_eq5.gro
file=md_eq_rep2

gmx_mpi grompp -f ./../mdp_single/$filein -c ./../md/$filegro -p ./../top/topol.top -o $file  -n ./../top/index.ndx -maxwarn 1 -r ./../md/$filegro


srun -K1 --mpi=cray_shasta  -N $nodes -n $ranks -c $threads  --accel-bind verbose  --cpu-bind cores   -m block:block gmx_mpi mdrun  -s $file.tpr -v -deffnm $file  -ntomp $threads -pin on -nb gpu -bonded gpu -update cpu  -maxh 23 

###### Preparing job_restart input files #####
echo "q" | gmx_mpi make_ndx -f ./../md/min.gro
gmx_mpi grompp -f ./../mdp_single/md-2.mdp -c md_eq_rep2.gro -p ./../top/topol.top -o md-2 -n index.ndx -maxwarn 1
